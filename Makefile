...
telekarma: main.o pcss.o sip.o state.o telekarma.o telephony.o controller.o cliview.o view.o model.o clicontext.o action.o sms.o
	g++ -o $@ $^ -lopal -lpt -L$(PREFIX)/lib
